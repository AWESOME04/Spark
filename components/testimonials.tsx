...
const testimonials = [
  {
    ...
    content:
      "As an influencer managing multiple platforms, Spark has been a game-changer. I can now direct my followers to one clean, professional link instead of cluttering my bio with multiple URLs. My engagement has increased by 30% since I started using it!",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "I've tried several link-in-bio tools, but Spark is by far the best. The analytics feature helps me understand which platforms are driving the most traffic, allowing me to focus my efforts where they matter most.",
    categories: [1, 2, 4],
  },
  {
    ...
    content:
      "The customization options in Spark are incredible! I was able to match my profile perfectly to my personal brand, and clients have commented on how professional and cohesive my online presence looks now.",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "Setting up my Spark profile took less than 10 minutes, and it's already driving more traffic to my online store. The ability to prioritize different links based on current promotions is incredibly valuable for my business.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Spark has simplified our agency's client management. We create custom profiles for each client, and the analytics dashboard makes reporting on performance straightforward and impressive. It's become an essential part of our toolkit.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Musician",
    content:
      "As a musician, I need to promote my music across multiple platforms. Spark lets me showcase my Spotify, SoundCloud, YouTube, and merch store all in one place. My fans love how easy it is to find everything now!",
    categories: [1, 3],
  },
  {
    ...
    content:
      "The QR code feature in Spark is brilliant! I printed it on my business cards, and now networking at tech conferences is so much more effective. People can access all my content with one quick scan.",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "I love how Spark lets me feature my latest podcast episodes prominently while still maintaining links to all my social channels. The custom domain feature gives my profile that extra professional touch.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Spark has streamlined how I connect with clients. I can organize links to my workout programs, nutrition guides, and social media all in one beautiful page. The setup was intuitive even for someone not tech-savvy like me!",
    categories: [1, 2],
  },
];
